...
const PRODUCTS = [
  ...
  { id: 5, nome: "Laço Classic Rope 30ft", marca: "Classic Rope", categoria: "Equipamentos", subcategoria: "Laços", preco: 349.00, precoAnterior: null, imagens: ["", "", ""], descricao: "Laço trançado de 30 pés, equilíbrio médio, indicado para quem está evoluindo técnica no team roping.", caracteristicas: ["30 pés", "Trançado 4 fios", "Rigidez média", "Ideal para header"], loja: "Amazon", linkCompra: "#", tags: ["laço", "team roping", "corda"], recomendado: "Mais vendido" },
  ...
  { id: 16, nome: "Luva de Roping Reforçada", marca: "Classic Rope", categoria: "Acessórios", subcategoria: "Luvas", preco: 89.90, precoAnterior: null, imagens: ["", "", ""], descricao: "Luva reforçada para melhor pega no laço, com respiro na palma e ajuste no punho.", caracteristicas: ["Reforço na palma", "Respiro traseiro", "Ajuste em velcro", "Uma unidade"], loja: "Amazon", linkCompra: "#", tags: ["luva", "acessório"], recomendado: "" },
