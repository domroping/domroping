/* ==========================================================================
   ...
   5. Um produto com "nome": "" é tratado como slot ainda não preenchido —
      aparece como "Produto em cadastro" / "Em breve", com a mesma estrutura
      de qualquer outro produto (página própria, favoritos, etc.).
   ========================================================================== */
...
/* Marcas curadas da DomRoping. Não há mais navegação/filtro por marca na
   interface — isso aqui é só a lista de referência interna. "Classic"
   agrupa tanto Classic Rope quanto Classic Equine numa marca só. */
...
/* Lista completa de marcas realmente em uso nos produtos (derivada, nunca
   precisa ser editada à mão). Não alimenta nenhum filtro ou navegação —
   fica só como referência interna dos dados. */
